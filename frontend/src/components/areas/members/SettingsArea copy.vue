	...
	<div class="selectContent" id="settings">
		...
		<section id="infoSection" class="mb-4 edit-section">
			...
			<div class="inp_modle">
				...
				<textarea v-model="user.summary" class="edit-input" style="resize: none" :placeholder="message.placeholder.summary" 
			...
			<div class="inp_modle towline">
				...
				<div class="d-flex flex-column align-items-center w-100">
					<div class="old row w-100">
						<input type="text" v-model="user.address" class="edit-input" :placeholder="message.placeholder.address" v-show="isEditingContact" />
